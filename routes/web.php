...
Route::get('/speciality/{speciality}', [PageController::class, 'showSpecialityPage'])->name('view.speciality');
...
Route::get('/rating', [PageController::class, 'showRatingPage'])->name('view.rating');
